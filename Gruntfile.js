...
// npm install --save-dev autoprefixer grunt grunt-concurrent grunt-contrib-clean grunt-contrib-concat grunt-contrib-connect grunt-contrib-copy grunt-contrib-csslint grunt-contrib-cssmin grunt-contrib-imagemin grunt-contrib-jshint grunt-contrib-uglify grunt-contrib-watch grunt-csscomb grunt-htmlhint grunt-includes grunt-newer grunt-postcss grunt-sass jit-grunt jshint-stylish time-grunt
	'use strict';
	...
	grunt.initConfig({
		...
		sass: {
			options: {
				...
				indentType : 'tab',         // 들여쓰기 공간사용
				indentWidth: 1,             // 들여쓰기 너비
		...
		concat: {
			...
			site: {
				src: [
					...
					//'<%= config.src %>/js/lib/jquery.fullPage.js',
					//'<%= config.src %>/js/lib/swiper.jquery.js',
					'<%= config.src %>/js/lib/jquery.bxslider.js',
					'<%= config.src %>/js/lib/slick.min.js',
					'<%= config.src %>/js/lib/jquery.easypiechart.min.js',
